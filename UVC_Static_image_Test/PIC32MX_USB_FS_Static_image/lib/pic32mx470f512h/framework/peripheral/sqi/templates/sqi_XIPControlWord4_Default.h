						   ...
						   uint8_t initCmd1 )
{
    ...
    sqi->SQIXCON4 = (initStatCheck << _SQI1XCON4_INIT2SCHECK_POSITION) |
		    (initCmdCount << _SQI1XCON4_INIT2COUNT_POSITION) |
		    (initCmdType << _SQI1XCON4_INIT2TYPE_POSITION) |
		    (initCmd3 << _SQI1XCON4_INIT2CMD3_POSITION) |
		    (initCmd2 << _SQI1XCON4_INIT2CMD2_POSITION) |
		    (initCmd1 << _SQI1XCON4_INIT2CMD1_POSITION);
}
