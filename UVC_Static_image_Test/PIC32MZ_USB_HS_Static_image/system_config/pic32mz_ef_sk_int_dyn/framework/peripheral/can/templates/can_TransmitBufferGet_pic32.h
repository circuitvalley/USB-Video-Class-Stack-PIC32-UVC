...
PLIB_TEMPLATE CAN_TX_MSG_BUFFER * CAN_TransmitBufferGet_pic32( CAN_MODULE_ID index , CAN_CHANNEL channel )
{
    ...
    /* Get address of FIFO from buffers */
	return (CAN_TX_MSG_BUFFER*) _PLIB_PhysToVirtK1(can->CFIFOREG[channel].CFIFOUA0);
}
...
#define PLIB_CAN_ExistsTransmitBufferGet PLIB_CAN_ExistsTransmitBufferGet
