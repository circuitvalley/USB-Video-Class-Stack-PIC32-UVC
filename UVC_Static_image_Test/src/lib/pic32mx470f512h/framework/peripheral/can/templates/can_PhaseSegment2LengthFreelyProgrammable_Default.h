...
PLIB_TEMPLATE void CAN_PhaseSegment2LengthFreelyProgrammableEnable_Default( CAN_MODULE_ID index )
{
	...
	can->CCFGSET = _C1CFG_SEG2PHTS_MASK;
}
...
{
	volatile can_registers_t * can = ((can_registers_t *)(index));
	can->CCFGCLR = _C1CFG_SEG2PHTS_MASK;
}
...
#define PLIB_CAN_ExistsPhaseSegment2LengthFreelyProgrammable PLIB_CAN_ExistsPhaseSegment2LengthFreelyProgrammable
