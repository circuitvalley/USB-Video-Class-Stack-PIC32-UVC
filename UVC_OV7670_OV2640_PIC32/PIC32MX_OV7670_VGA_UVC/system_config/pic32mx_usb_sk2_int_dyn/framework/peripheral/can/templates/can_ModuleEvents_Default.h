...
#ifndef _CAN_MODULEEVENTS_DEFAULT_H
#define _CAN_MODULEEVENTS_DEFAULT_H
...
PLIB_TEMPLATE void CAN_ModuleEventClear_Default( CAN_MODULE_ID index , CAN_MODULE_EVENT flags )
{
	...
	can->CINTCLR = (flags << _C1INT_TBIF_POSITION);
}
...
{
	volatile can_registers_t * can = ((can_registers_t *)(index));
	return (CAN_MODULE_EVENT) ( (can->CINT.w & CAN_All_EVENTS) >> _C1INT_TBIF_POSITION);
}
...
#define PLIB_CAN_ExistsModuleEventClear PLIB_CAN_ExistsModuleEventClear
...
#endif /*_CAN_MODULEEVENTS_DEFAULT_H*/
