...
void SYS_PORTS_Initialize(void)
{
    ...
    /* PPS Input Remapping */
    SYS_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_INT2, INPUT_PIN_RPD4);
    SYS_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_INT1, INPUT_PIN_RPG9);

   // SYS_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U1RX, INPUT_PIN_RPG8);

    /* PPS Output Remapping */
    SYS_PORTS_RemapOutput(PORTS_ID_0, OTPUT_FUNC_REFCLKO3, OUTPUT_PIN_RPB15);
    SYS_PORTS_RemapOutput(PORTS_ID_0, OTPUT_FUNC_REFCLKO1, OUTPUT_PIN_RPF0);
    //SYS_PORTS_RemapOutput(PORTS_ID_0, OTPUT_FUNC_U1TX, OUTPUT_PIN_RPG7);
