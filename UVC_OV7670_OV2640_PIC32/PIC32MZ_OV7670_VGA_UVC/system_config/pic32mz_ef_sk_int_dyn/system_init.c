...
// *****************************************************************************
 ...
 //<editor-fold defaultstate="collapsed" desc="USART init Data">
/*** System USART Initialization Data ***/
...
const DRV_PMP_INIT sysPMPinit =
{
    ...
    .polarity = 
            {
                .rwStrobePolarity = PMP_POLARITY_ACTIVE_HIGH,    //RD pin not used
...
//    SYS_INT_VectorSubprioritySet(INT_VECTOR_UART1_FAULT, INT_SUBPRIORITY_LEVEL0);
   ...
   //sysObj.sysPMP = DRV_PMP_Initialize(0,(SYS_MODULE_INIT *)&sysPMPinit);
    ...
    SYS_INT_VectorPrioritySet(CAM_I2C_VECTOR, INT_PRIORITY_LEVEL1);
    SYS_INT_VectorSubprioritySet(CAM_I2C_VECTOR, INT_SUBPRIORITY_LEVEL0);
    
    
    SYS_INT_VectorPrioritySet(INT_VECTOR_INT1, INT_PRIORITY_LEVEL1);            //Vsync
    ...
    SYS_INT_VectorPrioritySet(INT_VECTOR_INT2, INT_PRIORITY_LEVEL1);        //pixel clk
